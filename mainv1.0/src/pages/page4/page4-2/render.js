...
//接引数据源
import { LearningNotesSolutionsCN } from '../../../data/articles';
...
class Page4_2 extends Component {
	...
	render() {
        ...
        <Contents list={getContents(LearningNotesSolutionsCN)} onClick={this.chooseItem.bind(this)}></Contents>
			</div>
		)
	}

	chooseItem(v) {
    let article = getArticle(v, LearningNotesSolutionsCN);
...
export default connect(mapStateToProps, mapDispatchToProps)(Page4_2);
