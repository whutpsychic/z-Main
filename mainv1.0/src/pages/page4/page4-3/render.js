...
//接引数据源
import { LearningNotesExpsCN } from '../../../data/articles';
...
class Page4_3 extends Component {
	...
	render() {
        ...
        <Contents list={getContents(LearningNotesExpsCN)} onClick={this.chooseItem.bind(this)}></Contents>
			</div>
		)
	}

	chooseItem(v) {
    let article = getArticle(v, LearningNotesExpsCN);
...
export default connect(mapStateToProps, mapDispatchToProps)(Page4_3);
