...
//接引数据源
import { MovieActionsClassicCN } from '../../../data/articles';
	...
	render() {
		...
		return (
			<div className="left-content">
					<Contents list={getContents(MovieActionsClassicCN)} onClick={this.chooseItem.bind(this)}></Contents>
			</div>
		)
	}

	chooseItem(v) {
		let article = getArticle(v, MovieActionsClassicCN);
